...
const buttonVariants = cva(
  "uppercase inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 tracking-wide ",
  {
    variants: {
      variant: {
        default:
        ...
        sidebarOutline:
          "bg-sky-500/15 text-sky-500 hover:bg-sky-500/20 border-sky-300 border-2 transition-none",
      },
      size: {
